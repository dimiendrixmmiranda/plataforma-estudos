...
export default function Readaptacao() {
    return (
        <div className="p-4 bg-zinc-300 text-black min-h-[77vh] flex flex-col gap-3">
            <TituloMateria texto={`${estatutoDosServidoresDeJoaquimTavora["da-readaptacao"].titulo}`} />
            {
                estatutoDosServidoresDeJoaquimTavora["da-readaptacao"].arrayDeArtigos.map((artigo, i) => {
                    return (
            ...
            <div className="grid grid-cols-2 gap-2">
                <AncoraLink link="/pages/materias/estatutoDosServidores/da-disposicao" texto="Anterior" />
                <AncoraLink link="/pages/materias/estatutoDosServidores/da-substituicao" texto="Próximo" />
            </div>
        </div>
    )
}
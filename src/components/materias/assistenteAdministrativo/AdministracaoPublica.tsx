...
export default function AdministracaoPublica(){
    ...
    return (
        <div className="p-2 bg-zinc-300 text-black min-h-[77vh] flex flex-col gap-3">
            ...
            <TituloMateria texto={`${assistenteAdministrativo["administracao-publica"].titulo}`} />
            <IntroducaoMateria introducao={assistenteAdministrativo["administracao-publica"].introducao} />
            <ReproduzirTexto
                texto={
                    Array.isArray(assistenteAdministrativo["administracao-publica"].introducao)
                        ? assistenteAdministrativo["administracao-publica"].introducao.join(' ')
                        : assistenteAdministrativo["administracao-publica"].introducao
                }
            />
            <SubmateriasNavegacao arrayDeMaterias={assistenteAdministrativo["administracao-publica"].submaterias} />

            <ul className="flex flex-col gap-4">
                {
                    assistenteAdministrativo["administracao-publica"].submaterias.map((submateria, i) => {
                        return (

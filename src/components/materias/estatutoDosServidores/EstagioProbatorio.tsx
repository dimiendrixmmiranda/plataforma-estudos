...
export default function EstagioProbatorio() {
    return (
        <div className="p-4 bg-zinc-300 text-black min-h-[77vh] flex flex-col gap-3">
            <TituloMateria texto={`${estatutoDosServidoresDeJoaquimTavora["do-estagio-probatorio"].titulo}`} />
            {
                estatutoDosServidoresDeJoaquimTavora["do-estagio-probatorio"].arrayDeArtigos.map((artigo, i) => {
                    return (
            ...
            <div className="grid grid-cols-2 gap-2">
                <AncoraLink link="/pages/materias/estatutoDosServidores/do-exercicio" texto="Anterior" />
                <AncoraLink link="/pages/materias/estatutoDosServidores/da-estabilidade" texto="Próximo" />
            </div>
        </div>
    )
}
...
export default function DisponibilidadeEAproveitamento() {
    console.log(estatutoDosServidoresDeJoaquimTavora)
    return (
        <div className="p-4 bg-zinc-300 text-black min-h-[77vh] flex flex-col gap-3">
            <TituloMateria texto={`${estatutoDosServidoresDeJoaquimTavora["da-disponibilidade-e-do-aproveitamento"].titulo}`} />
            {
                estatutoDosServidoresDeJoaquimTavora["da-disponibilidade-e-do-aproveitamento"].arrayDeArtigos.map((artigo, i) => {
                    return (
            ...
            <div className="grid grid-cols-2 gap-2">
                <AncoraLink link="/pages/materias/estatutoDosServidores/da-reintegracao" texto="Anterior" />
                <AncoraLink link="/pages/materias/estatutoDosServidores/da-reversao" texto="Próximo" />
            </div>
        </div>
    )
}
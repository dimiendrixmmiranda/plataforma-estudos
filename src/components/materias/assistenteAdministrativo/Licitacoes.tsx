...
export default function Licitacoes(){
    ...
    return (
        <div className="p-2 bg-zinc-300 text-black min-h-[77vh] flex flex-col gap-3">
            ...
            <TituloMateria texto={`${assistenteAdministrativo.licitacoes.titulo}`} />
            <IntroducaoMateria introducao={assistenteAdministrativo.licitacoes.introducao} />
            <ReproduzirTexto
                texto={
                    Array.isArray(assistenteAdministrativo.licitacoes.introducao)
                        ? assistenteAdministrativo.licitacoes.introducao.join(' ')
                        : assistenteAdministrativo.licitacoes.introducao
                }
            />
            <SubmateriasNavegacao arrayDeMaterias={assistenteAdministrativo.licitacoes.submaterias} />

            <ul className="flex flex-col gap-4">
                {
                    assistenteAdministrativo.licitacoes.submaterias.map((submateria, i) => {
                        return (

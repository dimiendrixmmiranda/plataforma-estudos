...
export default function NocoesGeraisSobreArquivoDeDocumentos(){
    ...
    return (
        <div className="p-2 bg-zinc-300 text-black min-h-[77vh] flex flex-col gap-3">
            ...
            <TituloMateria texto={`${assistenteAdministrativo["nocoes-gerais-sobre-arquivos-de-documentos"].titulo}`} />
            <IntroducaoMateria introducao={assistenteAdministrativo["nocoes-gerais-sobre-arquivos-de-documentos"].introducao} />
            <ReproduzirTexto
                texto={
                    Array.isArray(assistenteAdministrativo["nocoes-gerais-sobre-arquivos-de-documentos"].introducao)
                        ? assistenteAdministrativo["nocoes-gerais-sobre-arquivos-de-documentos"].introducao.join(' ')
                        : assistenteAdministrativo["nocoes-gerais-sobre-arquivos-de-documentos"].introducao
                }
            />
            <SubmateriasNavegacao arrayDeMaterias={assistenteAdministrativo["nocoes-gerais-sobre-arquivos-de-documentos"].submaterias} />

            <ul className="flex flex-col gap-4">
                {
                    assistenteAdministrativo["nocoes-gerais-sobre-arquivos-de-documentos"].submaterias.map((submateria, i) => {
                        return (

...
export default function ContratosAdministrativos() {
    ...
    return (
        <div className="p-2 bg-zinc-300 text-black min-h-[77vh] flex flex-col gap-3">
            ...
            <TituloMateria texto={`${assistenteAdministrativo["contratos-administrativos"].titulo}`} />
            <IntroducaoMateria introducao={assistenteAdministrativo["contratos-administrativos"].introducao} />
            <ReproduzirTexto

                texto={
                    Array.isArray(assistenteAdministrativo["contratos-administrativos"].introducao)
                        ? assistenteAdministrativo["contratos-administrativos"].introducao.join(' ')
                        : assistenteAdministrativo["contratos-administrativos"].introducao
                }
            />
            <SubmateriasNavegacao arrayDeMaterias={assistenteAdministrativo["contratos-administrativos"].submaterias} />

            <ul className="flex flex-col gap-4">
                {
                    assistenteAdministrativo["contratos-administrativos"].submaterias.map((submateria, i) => {
                        return (

...
export default function AtosAdministrativos(){
    ...
    return (
        <div className="p-2 bg-zinc-300 text-black min-h-[77vh] flex flex-col gap-3">
            ...
            <TituloMateria texto={`${assistenteAdministrativo["atos-administrativos"].titulo}`} />
            <IntroducaoMateria introducao={assistenteAdministrativo["atos-administrativos"].introducao} />
            <ReproduzirTexto
                texto={
                    Array.isArray(assistenteAdministrativo["atos-administrativos"].introducao)
                        ? assistenteAdministrativo["atos-administrativos"].introducao.join(' ')
                        : assistenteAdministrativo["atos-administrativos"].introducao
                }
            />
            <SubmateriasNavegacao arrayDeMaterias={assistenteAdministrativo["atos-administrativos"].submaterias} />

            <ul className="flex flex-col gap-4">
                {
                    assistenteAdministrativo["atos-administrativos"].submaterias.map((submateria, i) => {
                        return (

...
export default function MovimentacaoDePessoal() {
    return (
        <div className="p-4 bg-zinc-300 text-black min-h-[77vh] flex flex-col gap-3">
            <TituloMateria texto={`${estatutoDosServidoresDeJoaquimTavora["da-movimentacao-de-pessoal-disposicoes-gerais"].titulo}`} />
            {
                estatutoDosServidoresDeJoaquimTavora["da-movimentacao-de-pessoal-disposicoes-gerais"].arrayDeArtigos.map((artigo, i) => {
                    return (
            ...
            <div className="grid grid-cols-2 gap-2">
                <AncoraLink link="/pages/materias/estatutoDosServidores/da-movimentacao-de-pessoal-disposicoes-gerais" texto="Anterior" />
                <AncoraLink link="/pages/materias/estatutoDosServidores/da-redistribuicao" texto="Próximo" />
            </div>
        </div>
    )
}
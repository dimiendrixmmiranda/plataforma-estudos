...
export default function ServicosPublicos() {
    ...
    return (
        <div className="p-2 bg-zinc-300 text-black min-h-[77vh] flex flex-col gap-3">
            ...
            <TituloMateria texto={`${assistenteAdministrativo["servicos-publicos"].titulo}`} />
            <IntroducaoMateria introducao={assistenteAdministrativo["servicos-publicos"].introducao} />
            <ReproduzirTexto
                texto={
                    Array.isArray(assistenteAdministrativo["servicos-publicos"].introducao)
                        ? assistenteAdministrativo["servicos-publicos"].introducao.join(' ')
                        : assistenteAdministrativo["servicos-publicos"].introducao
                }
            />
            <SubmateriasNavegacao arrayDeMaterias={assistenteAdministrativo["servicos-publicos"].submaterias} />

            <ul className="flex flex-col gap-4">
                {
                    assistenteAdministrativo["servicos-publicos"].submaterias.map((submateria, i) => {
                        return (

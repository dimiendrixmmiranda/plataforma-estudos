...
export default function ResponsabiladadesDosServidores() {
    ...
    return (
        <div className="p-2 bg-zinc-300 text-black min-h-[77vh] flex flex-col gap-3">
            ...
            <TituloMateria texto={`${assistenteAdministrativo["responsabilidades-dos-servidores"].titulo}`} />
            <IntroducaoMateria introducao={assistenteAdministrativo["responsabilidades-dos-servidores"].introducao} />
            <ReproduzirTexto
                texto={
                    Array.isArray(assistenteAdministrativo["responsabilidades-dos-servidores"].introducao)
                        ? assistenteAdministrativo["responsabilidades-dos-servidores"].introducao.join(' ')
                        : assistenteAdministrativo["responsabilidades-dos-servidores"].introducao
                }
            />
            <SubmateriasNavegacao arrayDeMaterias={assistenteAdministrativo["responsabilidades-dos-servidores"].submaterias} />

            <ul className="flex flex-col gap-4">
                {
                    assistenteAdministrativo["responsabilidades-dos-servidores"].submaterias.map((submateria, i) => {
                        return (

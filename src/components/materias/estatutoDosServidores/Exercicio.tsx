...
export default function Exercicio() {
    return (
        <div className="p-4 bg-zinc-300 text-black min-h-[77vh] flex flex-col gap-3">
            <TituloMateria texto={`${estatutoDosServidoresDeJoaquimTavora["do-exercicio"].titulo}`} />
            {
                estatutoDosServidoresDeJoaquimTavora["do-exercicio"].arrayDeArtigos.map((artigo, i) => {
                    return (
            ...
            <div className="grid grid-cols-2 gap-2">
                <AncoraLink link="/pages/materias/estatutoDosServidores/da-posse" texto="Anterior" />
                <AncoraLink link="/pages/materias/estatutoDosServidores/do-estagio-probatorio" texto="Próximo" />
            </div>
        </div>
    )
}